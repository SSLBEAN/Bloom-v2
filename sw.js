...
self.addEventListener('message', (event) => {
  ...
  event.waitUntil(
    self.registration.showNotification(title || 'Bloom', {
      ...
      badge: 'icon-192.png',
      tag: tag || undefined,
      renotify: !!tag, // if this notification reuses a tag (e.g. same conversation), still alert again
      vibrate: [120, 60, 120], // Android honors this; iOS/desktop silently ignore it
